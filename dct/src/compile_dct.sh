...
design_name=dct_bx16_by16_simdType0_simdLoc1_blockSizeF1_blockU0_DCTU0_simdwi1_compu2
...
design_name=dct_bx16_by16_simdType0_simdLoc1_blockSizeF1_blockU0_DCTU0_simdwi8_compu1
source_file_name="$design_name"".cl"
folder_rpt_name="$design_name""_rpt_name"
if [ ! -f ./$folder_rpt_name/quartus_sh_compile.log ]
then
...
design_name=dct_bx16_by16_simdType0_simdLoc1_blockSizeF2_blockU0_DCTU0_simdwi4_compu1
source_file_name="$design_name"".cl"
folder_rpt_name="$design_name""_rpt_name"
if [ ! -f ./$folder_rpt_name/quartus_sh_compile.log ]
then
...
design_name=dct_bx16_by16_simdType0_simdLoc2_blockSizeF1_blockU0_DCTU0_simdwi1_compu2
source_file_name="$design_name"".cl"
folder_rpt_name="$design_name""_rpt_name"
if [ ! -f ./$folder_rpt_name/quartus_sh_compile.log ]
then
...
design_name=dct_bx16_by16_simdType0_simdLoc2_blockSizeF1_blockU0_DCTU0_simdwi4_compu1
source_file_name="$design_name"".cl"
folder_rpt_name="$design_name""_rpt_name"
if [ ! -f ./$folder_rpt_name/quartus_sh_compile.log ]
then
...
design_name=dct_bx16_by64_simdType0_simdLoc2_blockSizeF1_blockU0_DCTU0_simdwi2_compu1
source_file_name="$design_name"".cl"
folder_rpt_name="$design_name""_rpt_name"
if [ ! -f ./$folder_rpt_name/quartus_sh_compile.log ]
then
...
design_name=dct_bx16_by64_simdType1_simdLoc2_blockSizeF1_blockU0_DCTU0_simdwi2_compu1
source_file_name="$design_name"".cl"
folder_rpt_name="$design_name""_rpt_name"
if [ ! -f ./$folder_rpt_name/quartus_sh_compile.log ]
then
...
design_name=dct_bx16_by8_simdType0_simdLoc2_blockSizeF1_blockU0_DCTU0_simdwi1_compu2
source_file_name="$design_name"".cl"
folder_rpt_name="$design_name""_rpt_name"
if [ ! -f ./$folder_rpt_name/quartus_sh_compile.log ]
then
...
design_name=dct_bx16_by8_simdType0_simdLoc2_blockSizeF1_blockU0_DCTU1_simdwi1_compu1
source_file_name="$design_name"".cl"
folder_rpt_name="$design_name""_rpt_name"
if [ ! -f ./$folder_rpt_name/quartus_sh_compile.log ]
then
...
design_name=dct_bx32_by16_simdType0_simdLoc1_blockSizeF1_blockU0_DCTU0_simdwi1_compu2
source_file_name="$design_name"".cl"
folder_rpt_name="$design_name""_rpt_name"
if [ ! -f ./$folder_rpt_name/quartus_sh_compile.log ]
then
...
design_name=dct_bx32_by16_simdType0_simdLoc1_blockSizeF2_blockU1_DCTU1_simdwi1_compu1
source_file_name="$design_name"".cl"
folder_rpt_name="$design_name""_rpt_name"
if [ ! -f ./$folder_rpt_name/quartus_sh_compile.log ]
then
...
design_name=dct_bx32_by16_simdType0_simdLoc2_blockSizeF1_blockU0_DCTU0_simdwi1_compu1
source_file_name="$design_name"".cl"
folder_rpt_name="$design_name""_rpt_name"
if [ ! -f ./$folder_rpt_name/quartus_sh_compile.log ]
then
...
design_name=dct_bx32_by16_simdType0_simdLoc2_blockSizeF1_blockU0_DCTU0_simdwi2_compu2
source_file_name="$design_name"".cl"
folder_rpt_name="$design_name""_rpt_name"
if [ ! -f ./$folder_rpt_name/quartus_sh_compile.log ]
then
